...
import 'astro_list.dart';

// Examples can assume:
// late BuildContext context;

/// Used with [AstroListTileTheme] to define default property values for
/// descendant [ListTile] widgets, as well as classes that build
/// [ListTile]s, like [CheckboxListTile], [RadioListTile], and
/// [SwitchListTile].
///
/// Descendant widgets obtain the current [AstroListTileThemeData] object
/// using [AstroListTileTheme.of]. Instances of [AstroListTileThemeData] can be
/// customized with [AstroListTileThemeData.copyWith].
///
/// A [AstroListTileThemeData] is often specified as part of the
/// overall [Theme] with [ThemeData.listTileTheme].
///
/// All [AstroListTileThemeData] properties are `null` by default.
...
///    application.
@immutable
class AstroListTileThemeData with Diagnosticable {
  static AstroListTileThemeData get defaults =>
      AstroListTileThemeData(minTileHeight: 34, minVerticalPadding: 0, contentPadding: EdgeInsets.symmetric(horizontal: 12, vertical: 2));

  /// Creates a [AstroListTileThemeData].
  const AstroListTileThemeData({
    this.dense,
    this.shape,
    this.style,
    this.selectedColor,
  ...
  /// new values.
  AstroListTileThemeData copyWith({
    bool? dense,
    ShapeBorder? shape,
    AstroListTileStyle? style,
    Color? selectedColor,
    Color? iconColor,
    Color? textColor,
  ...
  static AstroListTileThemeData? lerp(AstroListTileThemeData? a, AstroListTileThemeData? b, double t) {
    if (identical(a, b)) {
      return a;
    }
    return AstroListTileThemeData(
  ...
  bool operator ==(Object other) {
    ...
    return other is AstroListTileThemeData &&
        other.dense == dense &&
        other.shape == shape &&
        other.style == style &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<AstroListTileStyle>('style', style, defaultValue: null));
...
class AstroListTileTheme extends InheritedTheme {
  ...
  const AstroListTileTheme({
    super.key,
    AstroListTileThemeData? data,
    bool? dense,
    ShapeBorder? shape,
    AstroListTileStyle? style,
    Color? selectedColor,
  ...
  final AstroListTileThemeData? _data;
  final bool? _dense;
  final ShapeBorder? _shape;
  final AstroListTileStyle? _style;
  ...
  AstroListTileThemeData get data {
    return _data ??
        AstroListTileThemeData(
          dense: _dense,
          shape: _shape,
          style: _style,
  ...
  /// [AstroListTileThemeData.controlAffinity] property instead.
  ...
  ///
  /// If there is no enclosing [AstroListTileTheme] widget, then
  ...
  /// ```
  static AstroListTileThemeData of(BuildContext context) {
    final AstroListTileTheme? result = context.dependOnInheritedWidgetOfExactType<AstroListTileTheme>();
    return result?.data ?? AstroListTileThemeData.defaults;
  }
  ...
  static Widget merge({
    ...
    return Builder(
      builder: (BuildContext context) {
        final AstroListTileThemeData parent = AstroListTileTheme.of(context);
        return AstroListTileTheme(
          key: key,
          data: AstroListTileThemeData(
  ...
  @override
  bool updateShouldNotify(AstroListTileTheme oldWidget) => data != oldWidget.data;
}
